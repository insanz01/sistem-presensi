...
<html lang="en">
  <head>
    ...
    <title>Laporan Penilaian Agenda Kegiatan</title>
  </head>
  <body>
      ...
      <div class="mb-4">
        <div class="row">
          <div class="col-8 mx-auto">
            <div class="row">
              <div class="col-2">
                <img src="<?= base_url('assets\bahan\icon1.png') ?>" width="120%" alt="gambar">
              </div>
              <div class="col-1"></div>
              <div class="col-9">
        ...
        <tbody>
          ...
          <?php foreach($all_laporan as $laporan): ?>
            <tr>
              <td><?= $nomor++ ?></td>
              <td><?= $laporan['nama'] ?></td>
              <td><?= $laporan['disiplin_kerja'] ?></td>
              <td><?= $laporan['komunikasi'] ?></td>
              <td><?= $laporan['motivasi'] ?></td>
              <td><?= $laporan['inisiatif'] ?></td>
              <td><?= $laporan['kerjasama'] ?></td>
              <td><?= $laporan['etika'] ?></td>
              <td><?= $laporan['tanggung_jawab'] ?></td>
            </tr>
          <?php endforeach; ?>
        </tbody>
      </table>
